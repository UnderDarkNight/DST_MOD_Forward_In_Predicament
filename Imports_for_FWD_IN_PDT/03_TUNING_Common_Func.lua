...
TUNING["Forward_In_Predicament.Player_Com_Func"] = {"player","rpc","skin_player","cross_archived_data_sys","camera","picksound","pre_dodelta","vip","daily_task","normal_api","jade_coin_sys","personal_skin_unlocker"}
