...
local assets = {
    Asset("ANIM", "anim/fwd_in_pdt_food_yogurt.zip"), 
    Asset( "IMAGE", "images/inventoryimages/fwd_in_pdt_food_yogurt.tex" ),  -- 背包贴图
    Asset( "ATLAS", "images/inventoryimages/fwd_in_pdt_food_yogurt.xml" ),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("fwd_in_pdt_food_yogurt") -- 地上动画
    inst.AnimState:SetBuild("fwd_in_pdt_food_yogurt") -- 材质包，就是anim里的zip包
    ...
    inst.components.inventoryitem.imagename = "fwd_in_pdt_food_yogurt"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/fwd_in_pdt_food_yogurt.xml"
    ...
    --     bank = "fwd_in_pdt_food_yogurt",
    --     build = "fwd_in_pdt_food_yogurt",
    --     anim = "icon",
    --     hide_image = true,
    --     text = {
    --     --     -- color = {r,g,b,1},
