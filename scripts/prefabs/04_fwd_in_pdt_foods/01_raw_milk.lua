...
local function common_cooked_fn()
    ...
    inst:AddComponent("inventoryitem")
    -- -- inst.components.inventoryitem:ChangeImageName("leafymeatburger")
    inst.components.inventoryitem.imagename = "fwd_in_pdt_food_raw_milk_cooked"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/fwd_in_pdt_food_raw_milk_cooked.xml"
...
AddIngredientValues({"fwd_in_pdt_food_raw_milk"}, {dairy = 1,},true)
