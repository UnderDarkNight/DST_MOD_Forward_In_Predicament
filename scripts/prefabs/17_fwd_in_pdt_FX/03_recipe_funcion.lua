local assets = {
	...
	Asset("ANIM", "anim/fwd_in_pdt_recipes_fx_function.zip"),
}
...
local function fx()
    ...
    inst.AnimState:SetBank("fwd_in_pdt_recipes_fx_function")
    inst.AnimState:SetBuild("fwd_in_pdt_recipes_fx_function")
    ...
    inst:ListenForEvent("Set",function(inst,_table)
        ...
        inst.AnimState:PlayAnimation("fx_"..tostring(math.random(21)))
...
return Prefab("fwd_in_pdt_fx_recipe_function",fx,assets)