local assets = {
	...
	Asset("ANIM", "anim/fwd_in_pdt_recipes_fx_star.zip"),
}
...
local function fx()
    ...
    inst.AnimState:SetBank("fwd_in_pdt_recipes_fx_star")
    inst.AnimState:SetBuild("fwd_in_pdt_recipes_fx_star")
...
return Prefab("fwd_in_pdt_fx_recipe_star",fx,assets)