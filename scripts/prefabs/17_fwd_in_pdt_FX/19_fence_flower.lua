local assets = {
	...
	Asset("ANIM", "anim/fwd_in_pdt_fx_fence_flowers.zip"),
}
...
local function fx()
    ...
    inst.AnimState:SetBank("fwd_in_pdt_fx_fence_flowers")
    inst.AnimState:SetBuild("fwd_in_pdt_fx_fence_flowers")
...
return Prefab("fwd_in_pdt_fx_fence_flowers",fx,assets)