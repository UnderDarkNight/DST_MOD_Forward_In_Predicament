...
return Prefab("fwd_in_pdt_deep_freeze_new", fn, assets),
    MakePlacer("fwd_in_pdt_deep_freeze_new_placer", "fwd_in_pdt_deep_freeze_new", "fwd_in_pdt_deep_freeze_new", "idle")