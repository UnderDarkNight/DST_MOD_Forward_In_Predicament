...
local function fn()
    ...
    ---- 添加交互
            ...
            inst:ListenForEvent("fwd_in_pdt_event.OnEntityReplicated.fwd_in_pdt_com_workable",function(inst,replica_com)
                ...
                replica_com:SetText("fwd_in_pdt_building_materials_shop",GetStringsTable()["action_str"])
            end)
    ...
    ----- 商店
        ...
        inst.components.fwd_in_pdt_com_shop:SetListB(require("prefabs/07_fwd_in_pdt_buildings/03_materials_shop_items_b"))
        inst.components.fwd_in_pdt_com_shop:SetNumB(10)
