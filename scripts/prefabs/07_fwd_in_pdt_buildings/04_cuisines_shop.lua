...
local function GetStringsTable(name)
    local prefab_name = name or "fwd_in_pdt_building_cuisines_shop"
...
local assets =
{
    Asset("ANIM", "anim/fwd_in_pdt_building_cuisines_shop.zip"),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("fwd_in_pdt_building_cuisines_shop")
    inst.AnimState:SetBuild("fwd_in_pdt_building_cuisines_shop")
    inst.AnimState:PlayAnimation("idle",true)

    inst:AddTag("structure")
    inst:AddTag("fwd_in_pdt_building_cuisines_shop")
    ...
    ---- 添加交互
            ...
            inst:ListenForEvent("fwd_in_pdt_event.OnEntityReplicated.fwd_in_pdt_com_workable",function(inst,replica_com)
                ...
                replica_com:SetText("fwd_in_pdt_building_cuisines_shop",GetStringsTable()["action_str"])
...
return Prefab("fwd_in_pdt_building_cuisines_shop", fn, assets)