...
local assets =
{
    ...
    Asset("ANIM", "anim/fwd_in_pdt_coffeebush.zip"),

    Asset("ATLAS", "images/inventoryimages/fwd_in_pdt_coffeebush.xml"),
    Asset("IMAGE", "images/inventoryimages/fwd_in_pdt_coffeebush.tex"),

    Asset("IMAGE", "images/inventoryimages/fwd_in_pdt_dug_coffeebush.tex"),
    Asset("ATLAS", "images/inventoryimages/fwd_in_pdt_dug_coffeebush.xml"),
    Asset("ATLAS_BUILD", "images/inventoryimages/fwd_in_pdt_dug_coffeebush.xml", 256),
}
...
local function dig_up_common(inst, worker, numberries)
    if inst.components.pickable ~= nil and inst.components.lootdropper ~= nil then
        ...
        if withered or inst.components.pickable:IsBarren() then
            ...
            inst.components.lootdropper:SpawnLootPrefab("fwd_in_pdt_dug_coffeebush")
        end
    end
    inst:Remove()
end
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("fwd_in_pdt_coffeebush.tex")
    ...
    inst.AnimState:OverrideSymbol("berries", "fwd_in_pdt_coffeebush", "beans")
    inst.AnimState:OverrideSymbol("bush_berry_build", "fwd_in_pdt_coffeebush", "bush_berry_build")
    ...
    inst.components.pickable:SetUp("fwd_in_pdt_food_coffeebeans", TUNING.BERRY_REGROW_TIME)
...
local function ondeploy(inst, pt, deployer)
    local tree = SpawnPrefab("fwd_in_pdt_coffeebush")
    if tree ~= nil then
...
local function fn_dug()
    ...
    inst.AnimState:SetBank("fwd_in_pdt_coffeebush")
    inst.AnimState:SetBuild("fwd_in_pdt_coffeebush")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/fwd_in_pdt_dug_coffeebush.xml"
...
return Prefab("fwd_in_pdt_coffeebush", fn, assets),
    Prefab("fwd_in_pdt_dug_coffeebush", fn_dug, assets),
    MakePlacer("fwd_in_pdt_dug_coffeebush_placer", "fwd_in_pdt_coffeebush", "fwd_in_pdt_coffeebush", "idle")