...
--     local prefab_name = name or "fwd_in_pdt_plant_orange"
...
---- 使用官方的 pickable 组件
    ...
    local function add_pickable_action(inst)
        ...
        ------------------------
            ...
            --     doer.components.fwd_in_pdt_func:GiveItemByPrefab("fwd_in_pdt_plant_orange_seed",rice_num)
            --     inst:Remove()
            -- end)
        ------------------------
        ---- 自己封装个API 方便一些
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("fwd_in_pdt_plant_orange.tex")
...
return Prefab("fwd_in_pdt_plant_orange", fn, assets)