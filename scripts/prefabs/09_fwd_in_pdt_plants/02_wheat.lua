...
--     local prefab_name = name or "fwd_in_pdt_plant_wheat"
    ...
    local function add_workable_action(inst)
        ...
        ------------------------
            ...
            inst.components.pickable:SetOnPickedFn(function(inst,doer)  --- 被玩家采集后执行
                ...
                -- doer.components.fwd_in_pdt_func:GiveItemByPrefab("fwd_in_pdt_plant_wheat_seed",rice_num)
                ...
                if doer:HasTag("player") then
                    ...
                    TheWorld.components.fwd_in_pdt_func:Throw_Out_Items({
                            target = inst,
                            name = "fwd_in_pdt_plant_wheat_seed",
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("fwd_in_pdt_plant_wheat.tex")
    ...
    --- 可以挖掘
        ...
        inst.components.workable:SetOnFinishCallback(function()
            if inst.components.growable:GetStage() == 4 then
                inst.components.lootdropper:SetLoot({"fwd_in_pdt_plant_wheat_seed","fwd_in_pdt_plant_wheat_seed"})
            end
...
return Prefab("fwd_in_pdt_plant_wheat", fn, assets)