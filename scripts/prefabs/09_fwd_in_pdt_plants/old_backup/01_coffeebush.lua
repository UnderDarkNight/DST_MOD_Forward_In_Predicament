...
local function dig_up_common(inst, worker, numberries)
    if inst.components.pickable ~= nil and inst.components.lootdropper ~= nil then
        ...
        if inst.components.pickable:IsBarren() then
			...
			inst.components.lootdropper:SpawnLootPrefab("fwd_in_pdt_plant_coffeebush_item")
        end
    end
    inst:Remove()
end
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("fwd_in_pdt_plant_coffeebush.tex")
...
return Prefab("fwd_in_pdt_plant_coffeebush", fn, assets, prefabs)