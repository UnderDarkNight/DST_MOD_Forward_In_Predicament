...
--     local prefab_name = name or "fwd_in_pdt_plant_aster_tataricus_l_f"
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("fwd_in_pdt_plant_aster_tataricus_l_f.tex")
...
return Prefab("fwd_in_pdt_plant_aster_tataricus_l_f", fn, assets)