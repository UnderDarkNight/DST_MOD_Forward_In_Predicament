...
local function GetStringsTable(name)
    local prefab_name = name or "fwd_in_pdt_item_book_of_newmoon"
    local LANGUAGE = type(TUNING["Forward_In_Predicament.Language"]) == "function" and TUNING["Forward_In_Predicament.Language"]() or TUNING["Forward_In_Predicament.Language"]
    return TUNING["Forward_In_Predicament.Strings"][LANGUAGE][prefab_name] or {}
end

local assets = {
    Asset("ANIM", "anim/fwd_in_pdt_item_book_of_newmoon.zip"), 
    Asset( "IMAGE", "images/inventoryimages/fwd_in_pdt_item_book_of_newmoon.tex" ),  -- 背包贴图
    Asset( "ATLAS", "images/inventoryimages/fwd_in_pdt_item_book_of_newmoon.xml" ),
}

local function BookFn(inst,reader)      -- 新月
...
local function fn()
    ...
    inst.AnimState:SetBank("fwd_in_pdt_item_book_of_newmoon") -- 地上动画
    inst.AnimState:SetBuild("fwd_in_pdt_item_book_of_newmoon") -- 材质包，就是anim里的zip包
    ...
    --- 图层覆盖，sg 的 fwd_in_pdt_read_book_type_cookbook 里面
        ...
        inst.read_book_onenter_fn = function(inst,player)
            player.AnimState:OverrideSymbol("book_cook", "fwd_in_pdt_item_book_of_newmoon", "book_cook")
    ...
    inst.components.inventoryitem.imagename = "fwd_in_pdt_item_book_of_newmoon"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/fwd_in_pdt_item_book_of_newmoon.xml"
...
return Prefab("fwd_in_pdt_item_book_of_newmoon", fn, assets)