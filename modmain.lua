...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- 如果是进来想找免费的CD-KEY的，去MOD目录下 有个  cd_key.lua 文件，不用费力去找相关函数API在哪破解了。
-- If you come in and want to find a free CD-KEY, go to the MOD directory There is a cd_key.lua file
-- you don't need to find the relevant function API where to hook up.
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
