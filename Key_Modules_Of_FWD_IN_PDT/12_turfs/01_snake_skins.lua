...
local temp_assets = {
    ...
    -- 地皮贴图
        Asset( "IMAGE", "levels/textures/fwd_in_pdt_turf_snakeskin.tex" ),
        Asset( "IMAGE", "levels/textures/fwd_in_pdt_turf_snakeskin_mini.tex" ),
    -- 地皮边缘遮罩
        -- Asset( "IMAGE", "levels/tiles/fwd_in_pdt_turf_snakeskin.tex" ),
        -- Asset( "IMAGE", "levels/tiles/fwd_in_pdt_turf_snakeskin_mini.tex" ),
...
local turf_name = "fwd_in_pdt_turf_snakeskin"
