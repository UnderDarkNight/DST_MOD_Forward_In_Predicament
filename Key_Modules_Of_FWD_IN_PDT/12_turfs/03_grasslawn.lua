...
local temp_assets = {
    -- 被挖起来的地皮物品动画
        Asset("ANIM", "anim/fwd_in_pdt_turf_grasslawn.zip"), 
    -- 物品栏贴图
        Asset( "IMAGE", "images/inventoryimages/fwd_in_pdt_turf_grasslawn.tex" ),  -- 背包贴图
        Asset( "ATLAS", "images/inventoryimages/fwd_in_pdt_turf_grasslawn.xml" ),
    -- 地皮贴图
        Asset( "IMAGE", "levels/textures/fwd_in_pdt_turf_grasslawn.tex" ),
        Asset( "IMAGE", "levels/textures/fwd_in_pdt_turf_grasslawn_mini.tex" ),
    -- 地皮边缘遮罩
...
local turf_name = "fwd_in_pdt_turf_grasslawn"
...
AddTile(
    ...
    {                                                            --- ground_tile_def    应该是游戏场景内地皮相关的参数
        name="fwd_in_pdt_pebble",                                                  --- 地毯遮罩类型   resolvefilepath("levels/tiles/"..trimmed_name, true)
        noise_texture = turf_name,                      --- 地毯花纹，1024x1024 像素.【注意】没有“.tex”后缀。  resolvefilepath("levels/textures/"..trimmed_name, true)
        runsound="turnoftides/movement/run_grass",                --- 跑在上面的声音
        walksound="turnoftides/movement/walk_grass",               --- 走在上面的声音
