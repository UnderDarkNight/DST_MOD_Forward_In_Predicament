...
modimport("Key_Modules_Of_FWD_IN_PDT/05_Actions/04_com_action_workable.lua")             --- 【简易】物品给予动作 API 注册
modimport("Key_Modules_Of_FWD_IN_PDT/05_Actions/05_com_item_acceptable.lua")               --- 【简易】 inst 交互动作 API 注册。
modimport("Key_Modules_Of_FWD_IN_PDT/05_Actions/06_com_action_item_use_to.lua")               --- 【简易】 inst 交互动作 API 注册。
...
modimport("Key_Modules_Of_FWD_IN_PDT/05_Actions/11_read_book_action_spellbok.lua")       --- SG动作：读书(施法书)
