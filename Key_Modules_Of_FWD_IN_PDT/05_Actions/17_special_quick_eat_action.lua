...
AddStategraphState("wilson",State{
    name = "fwd_in_pdt_special_quick_eat",
    ...
    onenter = function(inst)
        ...
        inst.SoundEmitter:PlaySound("dontstarve/wilson/eat", "fwd_in_pdt_special_quick_eat")
    ...
    timeline =
        {
			...
			TimeEvent(60 * FRAMES, function(inst)
                inst.SoundEmitter:KillSound("fwd_in_pdt_special_quick_eat")
                inst:PerformBufferedAction()
...
AddStategraphState("wilson_client",State{
    name = "fwd_in_pdt_special_quick_eat",
    tags = { "doing", "busy", "canrotate","nointerrupt" },
    server_states = { "fwd_in_pdt_special_quick_eat" },
