...
modimport("Key_Modules_Of_FWD_IN_PDT/02_Original_Components_Upgrade/03_lunarthrall_plant.lua")   --- 避茄针hook

modimport("Key_Modules_Of_FWD_IN_PDT/02_Original_Components_Upgrade/04_tempurature_lock.lua")   --- 世界温度锁定器
