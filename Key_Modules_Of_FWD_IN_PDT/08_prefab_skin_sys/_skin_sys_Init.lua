...
modimport("Key_Modules_Of_FWD_IN_PDT/08_prefab_skin_sys/00_player_default_unlock_skins.lua")    --- 默认送给玩家的皮肤解锁列表

modimport("Key_Modules_Of_FWD_IN_PDT/08_prefab_skin_sys/01_player_theworld_hook.lua")    --- hook 进 玩家身上/TheWorld的组件,组件的添加和 hook 部分函数。

modimport("Key_Modules_Of_FWD_IN_PDT/08_prefab_skin_sys/02_item_prefab_skins_api.lua")    --- hook 进 系统API，以及添加自己的一套API基础数据容器。

modimport("Key_Modules_Of_FWD_IN_PDT/08_prefab_skin_sys/03_placer_com_upgrade.lua")    --- hook 进 placer 组件，让建筑放置的时候显示皮肤。

modimport("Key_Modules_Of_FWD_IN_PDT/08_prefab_skin_sys/04_test_add_recipe.lua")    --- 添加到制作栏 -- 测试用

modimport("Key_Modules_Of_FWD_IN_PDT/08_prefab_skin_sys/05_inventoryitem_com_upgrade.lua")    --- 修改物品图标组件，让皮肤切换的时候可以让图标初始化掉。

modimport("Key_Modules_Of_FWD_IN_PDT/08_prefab_skin_sys/06_named_com_upgrade.lua")    --- 修改名字组件，让名字可以初始化掉。

modimport("Key_Modules_Of_FWD_IN_PDT/08_prefab_skin_sys/07_reskin_tool_upgrade.lua")    --- 清洁扫把

modimport("Key_Modules_Of_FWD_IN_PDT/08_prefab_skin_sys/08_stackable_com_upgrade.lua")    --- hook 进叠堆组件，进行物品皮肤继承
